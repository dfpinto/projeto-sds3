create table tb_sales (id int8 generated by default as identity, amount float8, date date, deals int4, name varchar(255), visited int4, seller_id int8, primary key (id));
